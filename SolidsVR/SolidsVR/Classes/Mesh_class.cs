...
namespace SolidsVR
{
    class Mesh_class
    {
        ...
        public void RemoveElements()
        {
            ...
            for(int i = 0; i < 40;i++)
            {
                elements.RemoveAt(280);
            }

            for (int i = 0; i < 40; i++)
            {
                elements.RemoveAt(360);
            }
            */
            /*
            for (int i = 900; i < 990; i++)
            {
                elements.RemoveAt(900);
            }

            for (int i = 1080; i < 1170; i++)
            {
                elements.RemoveAt(1080);
            }

            for (int i = 1260; i < 1350; i++)
            {
                elements.RemoveAt(1260);
            }
            */
        }

        public void RemoveNodes2()
        {
            for (int i = 1364; i < 1426; i++)
            {
                nodes.RemoveAt(1364);
            }

            for (int i = 1674; i < 1736; i++)
            {
                nodes.RemoveAt(1674);
            }
        }
